...
async def run_once(task: str, question: str, context_dir: Path, run_dir: Path, config: dict[str, str], *,
    ...
    if prediction_path.exists():
        ...
        champion = run_champion_scorer(pred_root, context_dir.parent.parent.parent, task, Path(os.environ.get("KDDCUP_CHAMPION", str(Path("~/dev/kddcup2026_champion").expanduser()))))
