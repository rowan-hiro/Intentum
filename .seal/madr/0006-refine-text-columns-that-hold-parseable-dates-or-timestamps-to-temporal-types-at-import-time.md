...
Reconciled after the overwrite-permission follow-up: ISO probing, hint precedence, recorded refinement, and ordinary-failure compensation remain unchanged and are covered by the cumulative verifier.
