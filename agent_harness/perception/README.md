...
| Gateway | The champion's documented internal gateway | Existing `https://api.kilo.ai/api/gateway`; the champion's documented address timed out during a 10 s `/models` connectivity check |
